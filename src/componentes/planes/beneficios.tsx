...
import style from '@/componentes/planes/beneficios.module.css'
  ...
  return (
    <div className={style.contenedor}>
      ...
      <div className={style.cajas}>
        ...
        <div className={style.textos}><h1>Control total</h1>
      ...
      <div className={style.cajas}>
        ...
        <div className={style.textos}><h1>Mejor Google (SEO)</h1>
      ...
      <div className={style.cajas}>
        ...
        <div className={style.textos}><h1>Velocidad y experiencia</h1>
      ...
      <div className={style.cajas}>
        ...
        <div className={style.textos}><h1>Adaptación a móviles</h1>
